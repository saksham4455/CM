...
const vk1Departments = [
  ...
  },
  {
    ...
    members: [
      ...
      { id: "VK-1_DEVELOPER_5", name: "Daksh Baweja", position: "Manager", department: "DEVELOPER", img: "/Enigma_Team/Developer/Daksh .jpg" },
      { id: "VK-1_DEVELOPER_6", name: "Avnish Aryan", position: "Member", department: "DEVELOPER", img: "/Enigma_Team/Developer/Avnish.jpeg" },
      { id: "VK-1_DEVELOPER_7", name: "Shubbu Husain", position: "Member", department: "DEVELOPER", img: "/Enigma_Team/Developer/Shubbu Husain.jpg" },
      { id: "VK-1_DEVELOPER_8", name: "Jia Sharma", position: "Member", department: "DEVELOPER", img: "/Enigma_Team/Developer/Jia.png" },
      { id: "VK-1_DEVELOPER_9", name: "Harshit Sharma", position: "Member", department: "DEVELOPER", img: "/Enigma_Team/Developer/harshit.jpg" }
    ],
      color: "#00f3ff"
  },
  {
    ...
    members: [
      ...
      { id: "VK-1_EVENT_3", name: "Sidhant Mehta", position: "Assistant Director", department: "EVENT MANAGEMENT", img: "/Enigma_Team/Event/Sidhant Mehta  (Assistant Director).jpg" },
      { id: "VK-1_EVENT_4", name: "Puru Gupta", position: "Manager", department: "EVENT MANAGEMENT", img: "/Enigma_Team/Event/Puru Gupta Manager .jpg" },
      { id: "VK-1_EVENT_5", name: "Nysa Katyal", position: "Manager", department: "EVENT MANAGEMENT", img: "/Enigma_Team/Event/Nysa Katyal (manager).jpg" },
      { id: "VK-1_EVENT_6", name: "Kavya Datta", position: "Member", department: "EVENT MANAGEMENT", img: "/Enigma_Team/Event/kavya.jpeg" },
  ...
  },
  {
    ...
    members: [
      { id: "VK-1_SOCIALMEDIA_1", name: "Srijan Jha", position: "Director", department: "SOCIAL MEDIA", img: "/Enigma_Team/Social Media/Srijan Jha.jpg" },
      { id: "VK-1_SOCIALMEDIA_2", name: "Rashi Nagar", position: "Assistant Director", department: "SOCIAL MEDIA", img: "/Enigma_Team/Social Media/Rashi Naagar.jpg" },
      { id: "VK-1_SOCIALMEDIA_3", name: "Jasreet Kaur", position: "Manager", department: "SOCIAL MEDIA", img: "/Enigma_Team/Social Media/Jasreet.jpg" },
      { id: "VK-1_SOCIALMEDIA_4", name: "Jahanvi Sachdeva", position: "Manager", department: "SOCIAL MEDIA", img: "/Enigma_Team/Social Media/Jahanvi.jpg" },
      { id: "VK-1_SOCIALMEDIA_5", name: "Gurmeet Singh", position: "Manager", department: "SOCIAL MEDIA", img: "/Enigma_Team/Social Media/GURMEET SINGH.jpg" },
      { id: "VK-1_SOCIALMEDIA_7", name: "Tanishka Sangwan", position: "Member", department: "SOCIAL MEDIA", img: "/Enigma_Team/Social Media/Tanishka.jpg" },
      { id: "VK-1_SOCIALMEDIA_9", name: "Devanshi", position: "Member", department: "SOCIAL MEDIA", img: "/Enigma_Team/Social Media/Devanshi.jpeg" },
    ],
    color: "#00ff66"
  },
  {
...
const vk2Departments = [
  {
    name: "CORE",
    members: [
      { id: "VK-2_CORE_1", name: "Akshat ", position: "President", department: "CORE", img: "/BUGSLAYERS/Core/Akshat Arora,President.jpg" },
      { id: "VK-2_CORE_2", name: "Shubham", position: "Vice President", department: "CORE", img: "/BUGSLAYERS/Core/Shubham Singh,Vice president.jpg" },
      { id: "VK-2_CORE_3", name: "Simran", position: "Manager", department: "CORE", img: "/BUGSLAYERS/Core/Simran,Manager.jpg" },
    ],
    color: "#ff0000"
  },
  {
  ...
  },
  {
    ...
    members: [
      { id: "VK-2_EVENT_1", name: "Aditya Nath", position: "Coordinator", department: "EVENT COORDINATOR", img: "/BUGSLAYERS/Event coordinator/Aditya Nath,Coordinator,Mindmatrix.jpg" },
      { id: "VK-2_EVENT_2", name: "Anirban", position: "Coordinator", department: "EVENT COORDINATOR", img: "/BUGSLAYERS/Event coordinator/Anirban,Coordinator,MindMatrix.jpg" },
      { id: "VK-2_EVENT_3", name: "Hanisha", position: "Coordinator", department: "EVENT COORDINATOR", img: "/BUGSLAYERS/Event coordinator/Hanisha,Coordinator,UnseenTech.jpg" },
      { id: "VK-2_EVENT_4", name: "Krishank", position: "Coordinator", department: "EVENT COORDINATOR", img: "/BUGSLAYERS/Event coordinator/Krishank,Coordinator,Unseen Tech.jpg" },
      { id: "VK-2_EVENT_5", name: "Preeti", position: "Coordinator", department: "EVENT COORDINATOR", img: "/BUGSLAYERS/Event coordinator/Preeti,Coordinator,ShadowCode.jpg" },
      { id: "VK-2_EVENT_6", name: "Shreya Malhotra", position: "Coordinator", department: "EVENT COORDINATOR", img: "/BUGSLAYERS/Event coordinator/Shreya Malhotra,Coordinator,ShadowCode.jpg" }
    ],
    color: "#b100ff"
  },
  {
  ...
  },
  {
    name: "PHOTOGRAPHY",
    members: [
      { id: "VK-2_PHOTOGRAPHY_1", name: "Lakshay", position: "Head", department: "PHOTOGRAPHY", img: "/BUGSLAYERS/Photography/Lakshay,Head,photography.jpg" },
      { id: "VK-2_PHOTOGRAPHY_2", name: "Dharamveer", position: "Member", department: "PHOTOGRAPHY", img: "/BUGSLAYERS/Photography/Dharamveer,member,photography.jpg" },
      { id: "VK-2_PHOTOGRAPHY_3", name: "Manas", position: "Member", department: "PHOTOGRAPHY", img: "/BUGSLAYERS/Photography/Manas,member.jpg" },
      { id: "VK-2_PHOTOGRAPHY_4", name: "Yash", position: "Member", department: "PHOTOGRAPHY", img: "/BUGSLAYERS/Photography/Yash,Member.jpg" }
    ],
    color: "#00ff66"
  },
  {
